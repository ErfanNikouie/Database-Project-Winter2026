...
@callback(
    ...
    Input("insert-cancel", "n_clicks", allow_optional=True),
    Input("insert-confirm", "n_clicks", allow_optional=True),
    State({"type": "form-field-insert", "name": ALL}, "id", allow_optional=True),
    State({"type": "form-field-insert", "name": ALL}, "value", allow_optional=True),
...
@callback(
    ...
    Output("crud-action-local", "data", allow_duplicate=True),
    Output("crud-action-store", "data", allow_duplicate=True),
    Input("dynamic-grid", "cellDoubleClicked", allow_optional=True),
    Input("edit-cancel", "n_clicks", allow_optional=True),
    Input("edit-confirm", "n_clicks", allow_optional=True),
    State("dynamic-grid", "selectedRows", allow_optional=True),
    State({"type": "form-field-edit", "name": ALL}, "id", allow_optional=True),
    State({"type": "form-field-edit", "name": ALL}, "value", allow_optional=True),
    State("active-menu-id-hint", "data", allow_optional=True),
    State("auth-store", "data"),
    State("ui-store", "data"),
    State("schema-store", "data"),
